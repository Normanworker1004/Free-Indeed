...
class _ForgetPasswordScreenState extends State<ForgetPasswordScreen> {
  ...
  @override
  void initState() {
    _authenticationBloc.add(AuthenticationInitializeForgetPasswordEvent());
    super.initState();
  }
          ...
          return Scaffold(
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  HeaderWithLogo(headerTitle: "forget_password_page_title"),
                  getWhiteRectangle(context),
                ],
              ),
            ),
          );
        } else if (state is AuthenticationForgetPasswordReady) {
          enterPassword = state.enterPassword;
          return Scaffold(
            backgroundColor: GeneralConfigs.BACKGROUND_COLOR,
            body: SingleChildScrollView(
              child: Column(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  enterPassword
                      ? SignUpTextFormField(
                          label: "forget_password_page_password",
                          controller: passwordController,
                          showIcon: false)
                      : Container(),
                  enterPassword
                      ? SignUpTextFormField(
                          label: "forget_password_page_code",
  ...
  void confirmEmail(BuildContext context) {
    if (emailController.text.isNotEmpty) {
      _authenticationBloc.add(AuthenticationForgetPasswordEmailConfirm(
          username: emailController.text));
    } else {
      EasyLoading.showToast("Please insert a valid email");
    }
  }

  void confirmNewPassword(BuildContext context) {
    if (emailController.text.isNotEmpty &&
        passwordController.text.isNotEmpty &&
        codeController.text.isNotEmpty) {
      _authenticationBloc.add(AuthenticationForgetPasswordNewPasswordConfirm(
          username: emailController.text,
          newPassword: passwordController.text,
          code: codeController.text));
    } else {
      EasyLoading.showToast("Make sure all data is inserted");
    }
  }
